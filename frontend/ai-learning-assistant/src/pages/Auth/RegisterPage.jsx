      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="text-center mb-10">
            {/* 🔵 Logo — changed from emerald to fuchsia/purple */}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                {/* 🔵 Icon focus — changed from emerald to fuchsia */}
                <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
                  focusedField === "username" ? "text-fuchsia-500" : "text-slate-400"
                }`}>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60">
            <p className="text-center text-sm text-slate-600">
              ...
              {/* 🔵 Sign in link — changed from emerald to fuchsia */}
              <Link
                to='/login'
                className="font-semibold text-fuchsia-600 hover:text-fuchsia-700 transition-colors duration-200"
              >
                Sign in
              </Link>
            </p>
