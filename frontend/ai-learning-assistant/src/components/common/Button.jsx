...
const Button = ({
    ...
    const variantStyles = {
        primary:
            'bg-linear-to-r from-purple-500 to-pink-500 text-white shadow-lg shadow-purple-500/25 hover:from-purple-600 hover:to-pink-600 hover:shadow-xl hover:shadow-purple-500/30',
