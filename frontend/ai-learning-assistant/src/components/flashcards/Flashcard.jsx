            ...
            >
                ...
                >
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <div className="bg-purple-100 text-[10px] text-purple-700 rounded px-4 py-1 uppercase">
                        ...
                        <button
                            ...
                            className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                                flashcard.isStarred
                                    ? 'bg-linear-to-br from-purple-500 to-pink-500 text-white shadow-lg shadow-purple-500/25'
                ...
                <div
                    className="absolute inset-0 w-full h-full bg-linear-to-br from-purple-600 via-violet-500 to-pink-500 border-2 border-purple-400/60 rounded-2xl shadow-xl shadow-purple-500/30 p-8 flex flex-col justify-between"
                    style={{
                        backfaceVisibility: 'hidden',
                        WebkitBackfaceVisibility: 'hidden',
